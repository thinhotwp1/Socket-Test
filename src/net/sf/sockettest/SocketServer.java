...
public class SocketServer extends Thread {
    ...
    //disconnect client
    public synchronized void setDisconnection(boolean cr) {
        if (socket != null && cr) {
            try {
                socket.close();
            } catch (Exception e) {
                System.err.println("Error closing client : setDisconnection : " + e);
            }
        }
        desonnected = cr;
    ...
    public static synchronized SocketServer handle(SocketTestServer parent,
        ...
        if (socketServer == null)
            ...
            if (socketServer.server != null) {
                try {
                    socketServer.setDisconnection(true);
    ...
    private void startServer() {
        ...
        while (true) {
            ...
            if (rec != null) {
                ...
                //parent.append("R: "+rec);
                parent.appendnoNewLine("Message from client: " + rec);
            } else {
                setDisconnection(true);
